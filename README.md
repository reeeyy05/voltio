...
* **🏗️ Gestión de Obras (CRUD):** El núcleo de la aplicación permite crear, visualizar, actualizar y finalizar proyectos eléctricos, facilitando un seguimiento dinámico del ciclo de vida de cada obra.
* **📦 Control de Inventario y Materiales:** Registro detallado de los materiales utilizados en cada intervención para un control de costes estricto.
* **👷 Asignación de Personal:** Gestión de técnicos y cuadrillas asignados a obras específicas, garantizando la organización óptima del capital humano.
